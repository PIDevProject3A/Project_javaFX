...
public class PrevueCollection {
    ...
    private final IntegerProperty collectorId       = new SimpleIntegerProperty(0);
    ...
    public void   setTypeCollection(String v)  { typeCollection.set(v != null ? v.toLowerCase() : null); }
    ...
    public void   setStatut(String v)  { statut.set(v != null ? v.toLowerCase() : null); }
    ...
    public IntegerProperty collectorIdProperty() { return collectorId; }
